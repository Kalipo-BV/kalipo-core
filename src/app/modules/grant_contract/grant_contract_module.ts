...
export class GrantContractModule extends BaseModule {
    public actions = {
        ...
        // signGrantContract: async (params: Record<string, unknown>) => {
        //     console.log("peitje")
        //     const formData = (params as { formData: Buffer }).formData;
        //     this._channel.publish('grantContract:createAccount', {
        //         formData: formData
        //     });
        // }
    };
